      ...
      <div className="pb-20">
        ...
        <div className="bg-white shadow-sm overflow-hidden relative mb-2" style={{ height: '420px' }}>
          ...
          <div className="relative z-10 p-4">
            ...
            <div className="flex flex-col space-y-8" style={{ marginLeft: '20px' }}>
              {/* Step 1 - CKA not Completed */}
              <div className="flex items-start w-full max-w-sm">
                <div className="text-white flex items-center justify-center font-bold mr-4 flex-shrink-0 rounded-full" style={{ width: '34px', height: '34px', backgroundColor: '#b91c1c', fontSize: '16px' }}>
                  1.
                </div>
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <span className="font-bold underline text-sm" style={{ color: '#003049' }}>CKA not Completed</span>
                  </div>
                  <p className="text-black text-xs mb-2 text-left">
                    Investment Knowledge not Verified
                  </p>
                  <div className="h-2 bg-gray-300 rounded-full overflow-hidden" style={{ width: '183px' }}>
                    <div className="h-full rounded-full" style={{ width: '30%', backgroundColor: '#b91c1c' }}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start w-full max-w-sm">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <span className="font-bold underline text-sm" style={{ color: '#003049' }}>CAR not Completed</span>
                  </div>
                  <p className="text-black text-xs mb-2 text-left">
                    Risk Profile not Established
                  </p>
                  <div className="h-2 bg-gray-300 rounded-full overflow-hidden" style={{ width: '183px' }}>
                    <div className="h-full rounded-full" style={{ width: '15%', backgroundColor: '#b91c1c' }}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start w-full max-w-sm">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-sm" style={{ color: '#003049' }}>Ready to Invest!</span>
                  </div>
                  <p className="text-black text-xs mb-3 text-left">
                    You're eligible for <span className="font-semibold">(click to find out more):</span>
                  </p>
                  
                  {/* Action Buttons */}
                  <div className="flex gap-2">
                    <button className="font-bold rounded hover:opacity-90 transition-colors" style={{ width: '120px', height: '36px', backgroundColor: '#003049', color: '#FDF0D5', fontSize: '14px' }}>
                      Asia ETF
                    </button>
                    <button className="font-bold rounded hover:opacity-90 transition-colors" style={{ width: '120px', height: '36px', backgroundColor: '#003049', color: '#FDF0D5', fontSize: '14px' }}>
                      Unit Trust
