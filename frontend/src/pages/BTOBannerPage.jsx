...
function InvestmentPage3() {
  ...
  const [recommendedProduct, setRecommendedProduct] = useState('Income Portfolio'); // Default value
          ...
          <div className="relative z-10 p-4">
            ...
            <div className="flex flex-col items-center w-full" style={{ marginLeft: '0px' }}>
              ...
              <div className="relative w-full">
                <button className="font-bold hover:opacity-90 transition-colors flex items-center justify-center absolute" style={{ width: 165, height: 42, background: '#C1121F', boxShadow: '0px 4px 8px rgba(193, 18, 31, 0.4), 0px 2px 4px rgba(0, 0, 0, 0.25)', borderRadius: 30, color: '#FDF0D5', fontSize: '16px', left: '50px', top: '-15px' }}>
                  {recommendedProduct}
                </button>
              </div>
            </div>
