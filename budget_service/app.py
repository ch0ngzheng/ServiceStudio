...
def optimize_budget():
    ...
    print(f"[DEBUG] Predicted Proportions: {predicted_proportions}")
    print(f"[DEBUG] Categories Used: {CATEGORIES}")
    optimized_budget = {cat: round(total_budget * prop, 2) for cat, prop in zip(CATEGORIES, predicted_proportions)}
    print(f"[DEBUG] Calculated Optimized Budget: {optimized_budget}")
